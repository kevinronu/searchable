...
func UploadEmails(bulk *models.BulkEmails, zincCredentials models.ZincCredentials) error {
	...
	req, err := http.NewRequest("POST", zincCredentials.BaseUrl+uploadEndpoint, bytes.NewReader(jsonBytes))
	if err != nil {
		return err
	}
